                ...
                <div class="card overflow-hidden shadow rounded-4 border-0 mb-5">
                    <div class="card-body p-0">
                        <div class="d-flex align-items-center">
                            ...
                            <img class="img-fluid" src="{{ asset('assets/images/projects/project.png') }}" alt="Project 1" />
                        </div>
                    </div>
                </div>
                <!-- Project Card 2-->
                <div class="card overflow-hidden shadow rounded-4 border-0">
                    <div class="card-body p-0">
                        <div class="d-flex align-items-center">
                            ...
                            <img class="img-fluid" src="{{ asset('assets/images/projects/project.png') }}" alt="Project 2" />
                        </div>
                    </div>
                </div>
            </div>
